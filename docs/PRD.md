...
### 5.1 MVP Features (13 — must-have for defense; F11 added 2026-05-02 per ADR-031 / ADR-032; F12 + F13 added 2026-05-07 per ADR-036 / ADR-037)
...
- **AI service:** Python/FastAPI + OpenAI GPT-5.1-codex-mini + `text-embedding-3-small` + ESLint/Bandit/Cppcheck/PHPStan/PMD/Roslyn + Qdrant client *(ADR-003, ADR-004, ADR-036, ADR-037)*
