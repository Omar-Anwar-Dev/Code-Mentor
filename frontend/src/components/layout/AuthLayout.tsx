...
export const AuthLayout: React.FC = () => {
    return (
        <div className="min-h-screen flex">
            {/* Left Panel - Branding */}
            <aside
                aria-label="Code Mentor highlights"
            ...
            >
                {/* Background decorations — purely visual, hidden from AT. */}
            ...
            <main className="flex-1 flex items-center justify-center p-8 bg-neutral-50 dark:bg-neutral-900 transition-colors duration-300">
